...
class AdminCreateDriverReportRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
          ...
          "plateNumber" => ["required","exists:van,plate_number", new checkPlateNumber],
    ...
    public function messages()
    {
      ...
      $messages = [
        ...
        "plateNumber.required" => "Please select a plate number",
        "driverAndOperator.exists" => "Driver does not exists",
        "plateNumber.exists" => "Plate number does not exists",
