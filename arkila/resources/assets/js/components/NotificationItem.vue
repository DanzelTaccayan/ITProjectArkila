    ...
    mounted(){
      ...
      //Done
        ...
        if(this.unread.data.info.status == 'Unpaid'){
          ...
          this.time = moment(this.unread.data.info.departure_time, 'HH:mm').format('hh:mm a');
          this.details = this.destination + " on " + this.date + " at " + this.time;
          this.notificationUrl = "/home/rental";
        }else if(this.unread.data.info.status == 'Cancelled'){
      ...
      }else if(this.unread.data.notif_type == 'One Day Rental Notice'){
          if(this.unread.data.info == 1){
              this.title = "There's 1 van rental request due tomorrow";
              this.date = moment(this.unread.data.info.date).format('MM D YYYY');
              this.details = "On " + this.date;
              this.notificationUrl = "/home/rental";
          }else if(this.unread.data.info > 1){
              this.title = "There are "+this.unread.data.info+" van rental requests due tomorrow " + this.unread.data.info.date;
              this.date = moment(this.unread.data.info.date).format('MM D YYYY');
              this.details = "On " + this.date;
              this.notificationUrl = "/home/rental";
          }
