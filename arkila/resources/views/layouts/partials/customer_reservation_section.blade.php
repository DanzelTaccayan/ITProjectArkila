<section class="bar no-mb color-white padding-big text-md-center bg-primary" id="reservations">
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center"><img src="{{ URL::asset('img/IMG_0252.JPG') }}" alt="" class="img-fluid"></div>
            <div class="col-md-6"  style="margin-top:100px;">
              <h2 class="text-uppercase">Reservations</h2>
              <p class="mb-small">Get a privilege to be in our priority lane. Reserve a slot to one of our destinations</p>
