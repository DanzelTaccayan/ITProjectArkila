<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="{{ Request::is('home/trip-log') ? 'active' : '' }} || {{ Request::is('home/terminal/*') ? 'active' : '' }} || {{ Request::is('home/terminal') ? 'active' : '' }} || {{ Request::is('home/trip-log/*') ? 'active' : '' }}">
                <a href="{{route('trips.tripLog')}}">
                    <i class="fa fa-bus"></i>
                    <span>Trip Log</span>
                </a>
            </li>
