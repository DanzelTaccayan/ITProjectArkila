                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="" style="border: 1px solid lightgray; margin: 5px;">
                            ...
                            <li class="@if($terminals->first() == $terminal){{'active'}}@endif"><a href="#terminal{{$terminal->destination_id}}" data-toggle="tab">{{$mainTerminal->destination_name}} - {{$terminal->destination_name}}<span class="badge badge-pill pull-right">{{$terminal->routeFromDestination->count()}}</span></a></li>
                            @endforeach
                            </ul>
                        </div>
                    </div>
